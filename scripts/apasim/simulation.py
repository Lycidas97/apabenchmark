...
def allocate_reads_multi_pas(
    ...
    - percentage_diff_threshold (float, optional): Threshold for percentage difference to consider. Defaults to 0.5.
    ...
    while diff_flag:
        ...
        if comparison_type == "diff":
            ...
            if p > chi2_p_value or percentage_diff < percentage_diff_threshold:
                diff_flag = False
        else:
...
def generate_sim_bam(
    ...
    percentage_diff_threshold: float = 0.1,
    ...
    for te in diff_te_list:
        ...
        c_t1_vec, c_t2_vec = allocate_reads_multi_pas(
            pas_counts, diff_alpha, "diff", cell_num_per_type, dispersion, percentage_diff_threshold=percentage_diff_threshold
        )
    ...
    for te in non_diff_te_list:
        ...
        # generate read distribution
        c_t1_vec, c_t2_vec = allocate_reads_multi_pas(
            pas_counts, non_diff_alpha, "non_diff", cell_num_per_type, dispersion, percentage_diff_threshold=percentage_diff_threshold
        )
