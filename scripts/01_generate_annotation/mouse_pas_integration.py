#!/usr/bin/env python3
"""Script export of mouse_pas_integration.ipynb."""
...
POLYASITES_PATH="../../data/raw_data/annotations/atlas.clusters.3.0.GRCm38.GENCODE_M25.bed.gz"
POLYADB_PATH="../../data/raw_data/annotations/MousePas/mm10.PAS.main.tsv"
...
POLYADB_PROCESSED_PATH="../../data/raw_data/annotations/mousepas.mm10.processed.bed"

# set output data path
INTEGRATED_PAS_OUTPUT_PATH="../../data/int_data/annotations/mouse_integrated_pas.bed"
...
# %%
# process MousePas annotation; coordinates are already mm10, so no liftover is needed
polyadb = pd.read_csv(
    POLYADB_PATH,
    sep="	",
...
# 获取Gencode M25的PASs与MousePas的PASs在±10nt范围内有重叠的PAS
...
# # 获取MousePas的PASs与当前PAS集合中在±10nt范围内有重叠的PAS
...
if RUN_VENN:
    ...
    venn3(subsets=subsets,
          set_labels=('PolyASite3.0', 'MousePas', 'Gencode'))
    plt.show()
    plt.savefig("../../data/raw_data/annotations/mm10_venn3.svg", dpi=300)
...
# %%
# integrated_pas_final.to_csv("../../data/int_data/annotations/mouse_integrated_pas.bed", sep="\t", index=False, header=False)
