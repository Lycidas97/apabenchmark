#!/usr/bin/env python3
"""Prepare intermediate table for APA detect performance plots."""
...
SOURCE_RELATIVE = "data/result/merged_tool_performance/de_apa_performance.feather"
OUTPUT_NAME = "apa_detect_performance_prepared.tsv"
