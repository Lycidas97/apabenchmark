#!/usr/bin/env python3
"""Render PAS detect metric-by-protocol panels for sim data performance."""
...
def render_metric(df, metric: str) -> None:
    output_name = f"pas_detect_{metric}_by_protocol.pdf"
    ...
    fig.legend(
        ...
        labels,
        loc="upper center",
        bbox_to_anchor=(0.5, cfg_float("layout.pas_by_protocol_legend_y", 0.93)),
...
def main() -> None:
    ...
    apply_runtime_rcparams()
    df = load_metric_domain("match_performance")
