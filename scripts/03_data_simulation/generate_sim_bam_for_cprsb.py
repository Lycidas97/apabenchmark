...
"""
python generate_sim_bam_for_cprsb.py -g /path/to/GRCm38.p6.genome.fa \
    -p /path/to/apabenchmark_final/simulation/sim_peak/simulated_peak_ps1000_rl40.pickle \
    -a /path/to/apabenchmark_final/simulation/pas_performance/mm10_sim_pas_gn2000_rep1.bed \
    -b /path/to/apabenchmark_final/simulation/mm10_sim_rep1.bam \
    --barcode_num 10000
"""
