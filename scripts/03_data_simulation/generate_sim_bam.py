...
"""
python generate_sim_bam.py -g /path/to/GRCm38.p6.genome.fa \
    -p /path/to/apabenchmark_final/data/peaks/Visium_mouse_brain_V19L01-041-C1_peak.pickle \
    -a /path/to/apabenchmark_final/simulation/pas/mm10_sim_pas_rep1.bed \
